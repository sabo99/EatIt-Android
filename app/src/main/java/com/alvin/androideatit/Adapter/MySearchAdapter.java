...
public class MySearchAdapter extends RecyclerView.Adapter<MySearchAdapter.MyViewHolder> {
    ...
    public MySearchAdapter(Context context, List<FoodModel> foodModelList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.layout_search_item, parent, false));
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.img_quick_cart.setOnClickListener(view -> {
            ...
            cartItem.setFoodExtraPrice(0.0); // DEFAULT = 0
