package com.alvin.androideatit.Adapter;
...
import com.alvin.androideatit.Callback.IRecyclerClickListener;
...
public class MyPopularCategoriesAdapter extends RecyclerView.Adapter<MyPopularCategoriesAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        @BindView(R.id.txt_category_name) TextView txt_category_name;
        @BindView(R.id.category_image) CircleImageView category_image;
