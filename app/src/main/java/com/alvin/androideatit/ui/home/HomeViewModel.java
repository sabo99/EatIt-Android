package com.alvin.androideatit.ui.home;

import androidx.annotation.NonNull;
import androidx.lifecycle.MutableLiveData;
import androidx.lifecycle.ViewModel;

import com.alvin.androideatit.Callback.IBestDealCallbackListener;
import com.alvin.androideatit.Callback.IPopularCallbackListener;
import com.alvin.androideatit.Common.Common;
import com.alvin.androideatit.Model.BestDealModel;
import com.alvin.androideatit.Model.PopularCategoryModel;
    ...
    private void loadBestDealList() {
        ...
        bestDealRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot itemSapShot:dataSnapshot.getChildren())
                {
                    BestDealModel model = itemSapShot.getValue(BestDealModel.class);
                    tempList.add(model);
                }
    ...
    private void loadPopularList() {
        ...
        popularRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot itemSapShot:dataSnapshot.getChildren())
                {
                    PopularCategoryModel model = itemSapShot.getValue(PopularCategoryModel.class);
                    tempList.add(model);
                }
