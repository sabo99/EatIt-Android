package com.alvin.androideatit.Common;
...
import com.alvin.androideatit.Model.TokenModel;
...
public class Common {
    ...
    public static final String ALLFOODS_REF = "AllFoods";
    ...
    public static Double calculateExtraPrice(SizeModel userSelectedSize, List<AddonModel> userSelectedAddon) {
        ...
        {
            // If userSelectedAddon != null, need sum price
    ...
    public static void showNotification(Context context, int id, String title, String content, Intent intent) {
        ...
        String NOTIFICATION_CHANNEL_ID = "androdeatit";
